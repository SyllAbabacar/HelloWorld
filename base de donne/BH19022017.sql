...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 19 Février 2017 à 01:42
...
(9, 'Accessoire', 'Dans ce rubrique vous pouvez publier tout vos accessoire !!! '),
(10, 'Informatique', 'Dans ce rubrique vous pouvez publier tout vos matériel informatique !!!');
...
(60, '2016-01-05 08:31:17', 1, 14, 18, 337000, 'Feuiteil en main', 'csdqjcjqdcjdhcbqjhbqk:jcn xwh,b  cqjhcb  jcbq cbh', 'km', 0, 2, 19, 18),
(61, '2017-01-03 14:36:37', 2, 12, 19, 5480000, 'auto police', 'tres belle voiture', 'ici', 1, 1, 18, 18),
(62, '2017-01-05 00:22:25', 1, 13, 19, 500000, 'superbe moto honda', 'ohhhhhh c une superbe moto honda 2016\r\nouf c chaud !!!', 'ici', 0, 1, 18, 18),
(63, '2017-01-04 13:28:21', 2, 13, 19, 8450999, 'Guzzi 2016', 'vitesse 500km/h c superbe !!!', 'keur masssar', 1, 1, 19, 18),
(66, '2017-01-06 04:53:08', 1, 15, 18, 15000, 'montre unique', 'tbelle montre unique a son genre', 'keur massar', 1, 1, 18, 19),
(69, '2017-01-06 04:59:09', 1, 16, 19, 250000, 'portable motrolla moto g (4G)', 'profite de cette superbe portable motrolla 4G avec une exellente connection', 'colobane', 1, 1, 18, 19);
...
(2, 59, 5, '2016-12-30', '2018-12-21'),
(3, 63, 3, '2017-01-04', '2017-01-31'),
(4, 62, 3, '2017-01-01', '2017-02-28'),
(5, 60, 4, '2017-01-05', '2017-01-26'),
(6, 61, 4, '2017-01-01', '2017-01-31'),
(7, 62, 5, '2017-01-03', '2017-01-25'),
(8, 61, 5, '2017-01-06', '2017-01-31'),
(9, 66, 1, '2017-01-03', '2017-02-17'),
(10, 66, 5, '2016-12-04', '2017-01-31'),
(11, 69, 1, '2017-01-01', '2017-03-17'),
(12, 69, 3, '2016-11-30', '2017-01-13'),
(13, 66, 2, '2017-01-02', '2017-01-26'),
(14, 69, 4, '2016-12-21', '2017-01-19');
...
(12, 66, 'img16.jpg', 'tres belle vu de cette superbe montre'),
(13, 69, 'img2.jpg', 'envers du portable'),
(14, 69, 'img8.jpg', 'vue en face du portable');
...
--
ALTER TABLE `annonce`
  MODIFY `id_annonce` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
...
--
ALTER TABLE `duree`
  MODIFY `id_duree` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `type_annonce`
  MODIFY `id_type_annonce` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
